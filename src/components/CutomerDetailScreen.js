...
import { erpNextAxiosCall } from "../Apis/Axios";
import InvoicesTab from "./InvoicesTab";
import CutomerDetailScreenChart from "./CutomerDetailScreenChart";
...
const CutomerDetailScreen = ({ data, partyDetails }) => {
  ...
  return (
    <View style={styles.cutomerdetailscreen}>
      ...
      <CutomerDetailScreenChart partyDetails={partyDetails} />
